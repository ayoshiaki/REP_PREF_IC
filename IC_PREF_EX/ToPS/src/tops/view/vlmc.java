...
import static prefuse.demos.GraphView.demo;
 ...
 * @author fabinhosano
 */
public class vlmc extends JPanel{
    ...
    public vlmc(Graph g, String label){
...
//        opanel.add(overview);
    ...
    public static JFrame demo(Graph g, String label) {
        final vlmc view = new vlmc(g, label);
        
        // set up menu
        /*JMenu dataMenu = new JMenu("Data");
        dataMenu.add(new vlmc.OpenGraphAction(view));
        dataMenu.add(new vlmc.GraphMenuAction("Grid","ctrl 1",view) {
            protected Graph getGraph() {
                return GraphLib.getGrid(15,15);
            }
        });
        dataMenu.add(new vlmc.GraphMenuAction("Clique","ctrl 2",view) {
            protected Graph getGraph() {
                return GraphLib.getClique(10);
            }
        });
        dataMenu.add(new vlmc.GraphMenuAction("Honeycomb","ctrl 3",view) {
            protected Graph getGraph() {
                return GraphLib.getHoneycomb(5);
            }
        });
        dataMenu.add(new vlmc.GraphMenuAction("Balanced Tree","ctrl 4",view) {
            protected Graph getGraph() {
                return GraphLib.getBalancedTree(3,5);
            }
        });
        dataMenu.add(new vlmc.GraphMenuAction("Diamond Tree","ctrl 5",view) {
            protected Graph getGraph() {
        ...
        */
        ...
        JFrame frame = new JFrame("v l m c  |  variable length markov chain");
