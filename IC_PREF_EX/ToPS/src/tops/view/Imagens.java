 ...
 * @author fabinhosano
 */
public class Imagens extends Display {

    public Imagens(Table t) {
        ...
        init.add(new Imagens.ImagensSizeAction());
        m_vis.putAction("init", init);

        ActionList update = new ActionList();
        update.add(new Imagens.ImagensSizeAction());
        ...
        preforce.add(new Imagens.ImagensForceLayout(true));
        m_vis.putAction("preforce", preforce);

        // this will cause docs to move out of the way when dragging
        final ForceDirectedLayout fl = new Imagens.ImagensForceLayout(false);
        ...
        setItemSorter(new Imagens.ImagensSorter());
        addControlListener(new Imagens.ImagensControl());
    ...
    public static JComponent demo() {
        ...
        return new Imagens(data);
    }

    // ------------------------------------------------------------------------
    public static class ImagensSorter extends ItemSorter {

        public int score(VisualItem item) {
            return (int) (10000 * item.getY());
        }
    } // end of inner class Imagens Comparator

    public class ImagensSizeAction extends SizeAction {

        public double getSize(VisualItem item) {
            double y = item.getEndY();
            return 0.5 + y / 1400;
        }
    } // end of inner class ImagensSizeAction
    ...
    public class ImagensForceLayout extends ForceDirectedLayout {

        public ImagensForceLayout(boolean enforceBounds) {
    ...
    } // end of inner class ImagensForceLayout

    public class ImagensControl extends ControlAdapter {
    ...
    } // end of inner class ImagensControl
}
